...
class AgentRunner:
    ...
    def analyze(self, query: str, model_id: str = "qwen2.5:3b") -> dict[str, Any]:
        """
        Analisi in due fasi:
    ...
    def direct_query(self, query: str, model_id: str = "qwen2.5:3b") -> dict[str, Any]:
        """
...
def run(query: str, model_id: str = "qwen2.5:3b", use_agent: bool = False) -> dict[str, Any]:
