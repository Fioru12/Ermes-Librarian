...
class IntegrationsConfig:
    ...
    OLLAMA_HOST: str = field(
        default_factory=lambda: os.environ.get("ERMES_OLLAMA_HOST", "http://localhost:11434")
    )
    DEFAULT_MODEL_ID: str = field(
        default_factory=lambda: os.environ.get("ERMES_DEFAULT_MODEL_ID", "llama3.2:latest")
    )
    ...
    OPENROUTER_API_KEY: str = field(
        default_factory=lambda: os.environ.get("ERMES_OPENROUTER_API_KEY", "")
    )
    ...
    TEAMS_WEBHOOK_SECRET: str = field(
        default_factory=lambda: os.environ.get("ERMES_TEAMS_WEBHOOK_SECRET", "")
    )
    SLACK_SIGNING_SECRET: str = field(
        default_factory=lambda: os.environ.get("ERMES_SLACK_SIGNING_SECRET", "")
    )
    SLACK_BOT_TOKEN: str = field(
        default_factory=lambda: os.environ.get("ERMES_SLACK_BOT_TOKEN", "")
    )
    TELEGRAM_BOT_TOKEN: str = field(
        default_factory=lambda: os.environ.get("ERMES_TELEGRAM_BOT_TOKEN", "")
    )
