...
def parse_catalog() -> list[dict[str, Any]]:
    ...
    for line in text.splitlines():
        # Support both old format (### <a name="id"></a> id — name) and new format (## [id](#id) | name | tipo | categoria)
        ...
        if m:
            ...
            tipo = m.group(3).strip() if m.lastindex >= 3 else None
            current = {"id": fid, "name": name, "tipo": tipo, "code": "", "scopo": ""}
